 ...
 */
package com.bocop.zyt.jx.ab.common.pullview;
...
import com.bocop.zyt.jx.common.util.AbDateUtil;
import com.bocop.zyt.jx.common.util.AbViewUtil;
...
public class AbListViewHeader extends LinearLayout {
	...
	private void initView(Context context) {
		...
		arrowImage = BitmapFactory.decodeResource(getResources(), R.drawable.icon_refresh_arrow);
