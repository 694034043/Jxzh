 ...
 */
package com.bocop.zyt.jx.ab.view.sliding;
...
import com.bocop.zyt.jx.ab.adapter.AbViewPagerAdapter;
import com.bocop.zyt.jx.common.util.AbFileUtil;
...
public class AbSlidingPlayView extends LinearLayout {
	 ...
	 * 播放间隔
	 */
	private long playDuration = 3000;
	...
	public void setPlayDuration(long duration) {
		if (duration <= 1000) {
			Log.e(VIEW_LOG_TAG, "播放间隔不能小于等于1000ms");
			return;
		}
