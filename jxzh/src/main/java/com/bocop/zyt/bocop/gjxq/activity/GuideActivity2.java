...
public class GuideActivity2 extends BaseActivity {
	...
	private void showPopupWindow(View view) {
		View layout = LayoutInflater.from(GuideActivity2.this).inflate(R.layout.dialog_attention, null);
		...
		dAdapter = new Attention_Dialog_adapter(gList, GuideActivity2.this);
