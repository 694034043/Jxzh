...
public class LYTActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        htzq_webView.setWebViewClient(new WebViewClient(){
			...
			public void onPageStarted(WebView view, String url, Bitmap favicon) {
				...
				if (NetworkUtils.isNetworkConnected(LYTActivity.this)) {
					llNetworkLoad.setVisibility(View.INVISIBLE);
					htzq_webView.setVisibility(View.VISIBLE);
					llNetworkClosed.setVisibility(View.INVISIBLE);
				} else {
					view.stopLoading();
					CustomProgressDialog.showBocNetworkSetDialog(LYTActivity.this);
		...
		if(LoginUtil.isLog(this)){
			htzq_webView.loadUrl(BocSdkConfig.LYT + "?accessToken=" + LoginUtil.getToken(this) + "&userid="  +  LoginUtil.getUserId(this));
		}else{
			htzq_webView.loadUrl(BocSdkConfig.LYT);
		}
