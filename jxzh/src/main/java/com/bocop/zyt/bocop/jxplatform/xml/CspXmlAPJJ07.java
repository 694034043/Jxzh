 ...
 *
 */
public class CspXmlAPJJ07 {
	
	public CspXmlAPJJ07(String strDriveNum){
		DriveNum = strDriveNum;
	}
	...
	private static String TRN_CODE = TransactionValue.APJJ07;
