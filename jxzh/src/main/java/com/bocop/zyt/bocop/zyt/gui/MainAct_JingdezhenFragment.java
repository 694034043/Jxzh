...
public class MainAct_JingdezhenFragment extends BaseFragment implements View.OnClickListener {
    ...
    public void onDestroy() {
        super.onDestroy();
        ILOG.log_4_7("MainAct_JingdezhenFragment  onDestroy ");
        _timer.cancel();
        _timer = null;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.act_main_jing_de_zhen_fragment, null);
        tv_actionbar_title = (TextView) v.findViewById(R.id.tv_actionbar_title);
        tv_actionbar_title.setText(ICONST.YZT_Module_Name);
...
//        iv_bottom_ad_02.setLayoutParams(p);
        ...
        FImageloader.load_by_resid_fit_src(getActivity(), R.drawable.pic_jing_bottom_ad_01, iv_bottom_ad_01);
        FImageloader.load_by_resid_fit_src(getActivity(), R.drawable.pic_jing_bottom_ad_02, iv_bottom_ad_02);
        show_top_banner();
    ...
    public static final int[] top_banner_pics = {
            R.drawable.pic_banner_yin_zhen_tong_01,
            R.drawable.pic_banner_gan_jiang_xin_qu_02,
            R.drawable.pic_zheng_top_banner_03,
    };
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.ll_item_01_01_01: {
            	KhtActivity.startAct(getActivity(), IURL.Bank_kht_yzt_url, "开户通");
                break;
            }
            case R.id.ll_item_01_01_02: {
            	WebActivity.startAct(getActivity(), IURL.Jing_qi_dai_tong,"企贷通","");
                break;
            }
            case R.id.ll_item_01_01_03: {
                XWebAct.startAct(getActivity(), IURL.Bank_ZHong_Xiao_Tong, "中小通","");
                break;
            }
...
//            	ImageAdsAct.startAct(getActivity(), R.drawable.bg_pic_qi_fu_tong, "企付通");
            ...
            case R.id.ll_item_01_02_01: {
            	WebActivity.startAct(getActivity(), IURL.Jing_dan_zheng_tong,"单证通","");
                break;
            }
            case R.id.ll_item_01_02_02: {
            	WebActivity.startAct(getActivity(), IURL.Jing_bao_han_tong,"保函通","");
                break;
            }
...
//              	ImageAdsAct.startAct(getActivity(), R.drawable.bg_pic_che_shang_tong, "车商通");
            ...
            case R.id.iv_bottom_ad_01: {
                ImageAdsAct.startAct(getActivity(), R.drawable.bg_pic_ju_ming_jian_kang_ka, "居民健康卡介绍");
                break;
            }
            case R.id.iv_bottom_ad_02: {
                ImageAdsAct.startAct(getActivity(), R.drawable.bg_pic_zhong_xiao_tong, "中小通");
                break;
            }
        }
    }
