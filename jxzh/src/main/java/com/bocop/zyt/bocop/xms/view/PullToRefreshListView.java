package com.bocop.zyt.bocop.xms.view;
...
import com.bocop.zyt.bocop.xms.internal.EmptyViewMethodAccessor;
import com.bocop.zyt.bocop.xms.internal.LoadingLayout;
...
public class PullToRefreshListView extends PullToRefreshAdapterViewBase<ListView> {
	...
	protected final ListView createRefreshableView(Context context, AttributeSet attrs) {
		...
		String pullLabel = "滑动刷新";
		String refreshingLabel = "加载中";
		String releaseLabel = "释放刷新";
		// Add Loading Views
