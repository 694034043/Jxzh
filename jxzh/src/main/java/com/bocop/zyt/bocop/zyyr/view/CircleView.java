package com.bocop.zyt.bocop.zyyr.view;
...
public class CircleView extends View {
	...
	private void init(AttributeSet attrs, int defStyle) {
		...
		mFillColor = a.getColor(R.styleable.CircleView_filllColor, DEFAULT_FILL_COLOR);
	...
	protected void onDraw(Canvas canvas) {
		...
		if (mShowTitle) {
			//TODO
			canvas.drawText(mTitleText, xPos, yPos-15, mTitleTextPaint);
		}

		if (mShowSubtitle) {
			//TODO
			canvas.drawText(mSubtitleText, xPos, yPos + 30, mSubTextPaint);
		}
	 ...
	 * 
	 * @param fillColor
	 *            The fill color attribute value to use.
	 */
	 ...
	 * 
	 * @param strokeWidth
	 *            The stroke width attribute value to use.
	 */
	 ...
	 * 
	 * @param fillRadius
	 *            The fill radius attribute value to use.
	 */
	 ...
	 * 
	 * @param titleSize
	 *            The title size dimension attribute value to use.
	 */
	 ...
	 * 
	 * @param subtitleSize
	 *            The subtitle size dimension attribute value to use.
	 */
