 ...
 * 
 */
public class QztFristActivity extends BaseActivity implements LoginUtil.ILoginListener {
	// txm
	...
	private void initView() {
		baseActivity = (BaseActivity) QztFristActivity.this;
		...
		gridview_allmodule.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1,
				...
				case 1:
					...
					if (baseApplication.isNetStat()) {
						if (LoginUtil.isLog(baseActivity)) {
							...
							LoginUtil.authorize(QztFristActivity.this,
									QztFristActivity.this);
						}
					} else {
						CustomProgressDialog
								.showBocNetworkSetDialog(baseActivity);
				...
				case 3:
					...
					Intent intentDotbook = new Intent(QztFristActivity.this,
							WebActivity.class);
				...
				case 4:
					...
					Intent intentDotbook1 = new Intent(QztFristActivity.this,
							WebActivity.class);
				...
				case 5:
					...
					Intent intentJincai = new Intent(QztFristActivity.this,
							WebActivity.class);
	...
	public void onLogin() {
		...
		Toast.makeText(QztFristActivity.this, "登陆成功", Toast.LENGTH_LONG).show();
	}
