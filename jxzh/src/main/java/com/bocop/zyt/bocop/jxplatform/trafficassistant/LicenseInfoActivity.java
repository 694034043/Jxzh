...
import com.bocop.zyt.bocop.jxplatform.xml.CspXmlAPJJ05;
import com.bocop.zyt.bocop.jxplatform.xml.CspXmlAPJJ06;
import com.bocop.zyt.bocop.jxplatform.xml.CspXmlAPJJ07;
...
//								Toast.makeText(LicenseInfoActivity.this, "请前往中银开发平台实名认证", Toast.LENGTH_LONG).show();
	...
	private void requestCspForLicenseAdd() {
		try {
			LicenseInfoBean Info = new LicenseInfoBean(strIdNo,LoginUtil.getUserId(this), strFileNumAdd, strTel);
			//生成CSP XML报文
			CspXmlAPJJ05 cspXmlAPJJ05 = new CspXmlAPJJ05(Info);
			String strXml = cspXmlAPJJ05.getCspXml();
			//生成MCIS报文
			Mcis mcis = new Mcis(strXml,TransactionValue.APJJ05);
...
//					SA0052 sa0052;
	...
	protected void requestCspForDriveDatesRemove() {
		...
		try {
			...
			cspUtil.postCspLogin(mcis, new CspUtil.CallBack() {
