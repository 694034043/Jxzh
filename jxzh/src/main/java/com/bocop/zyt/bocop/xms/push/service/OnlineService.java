package com.bocop.zyt.bocop.xms.push.service;
...
import com.bocop.zyt.bocop.xms.push.impl.MsgImpl;
import com.bocop.zyt.bocop.xms.push.listener.OnReciveMsgListener;
import com.bocop.zyt.bocop.xms.push.receiver.TickAlarmReceiver;
import com.bocop.zyt.bocop.xms.push.runnable.UdpClientImpl;
import com.bocop.zyt.bocop.xms.push.util.SimpleNotifation;
...
public class OnlineService extends Service {
	...
	private void requestRegiestDevice() {
		...
		CspUtil.CallBack callBack = new CspUtil.CallBack() {
	...
	private void requestUUID() {
		...
		RequestBody formBody = new FormEncodingBuilder()
				...
				.build();
		CspUtil cspUtil = new CspUtil(this);
		cspUtil.postCspNoLogin(BocSdkConfig.SECRETARY_REQUEST_UUID_PATH, formBody, false, new CspUtil.CallBack() {
