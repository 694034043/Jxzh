...
import com.bocop.zyt.bocop.xms.activity.GuideActivity;
import com.bocop.zyt.bocop.xms.activity.MyMessageActivity;
...
public class MyMessageAdapter extends BaseAdapter{
	...
	public MyMessageAdapter(MyMessageActivity activity, ArrayList<MessageBean> list){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null){
			convertView=LayoutInflater.from(activity).inflate(
					R.layout.xms_item_my_message, null);
