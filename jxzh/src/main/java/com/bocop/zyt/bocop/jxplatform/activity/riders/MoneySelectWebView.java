...
public class MoneySelectWebView extends Activity {
	...
	private String channel = "?channel=android&source=000001";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		title = StringUtil.isNullOrEmpty(title)?"易商理财":title;
		initView();
		getFinances(this);
		// initWebView();
		setListener();
	...
	void initWebView() {
		...
		currentUrl = url;
		webView.loadUrl(url);
		if ("https:/openapi.boc.cn/ezdb/mobileHtml/html/userCenter/index.html?channel=android&source=000001"
				.equals(url)) {// H5列表首页
			isNative = false;
		} else {
			isNative = true;
				...
				new JsonHttpResponseHandler("UTF-8") {
					...
					public void onSuccess(int statusCode, Header[] headers,
						...
						try {
							...
							url = "https:/openapi.boc.cn/ezdb/mobileHtml/html/userCenter/index.html?channel=android&source=000001";
							initWebView();
