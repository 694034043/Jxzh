package com.bocop.zyt.bocop.jxplatform.gesture;
...
import com.bocop.zyt.bocop.jxplatform.gesture.view.LocusPassWordView;
...
public class MineSetGesturePwdActivity extends BaseActivity {
	 ...
	 */
	private LocusPassWordView.OnCompareListener lpwvOnCompareListener = new LocusPassWordView.OnCompareListener() {
	 ...
	 * 第一次输入新密码后，更新上方的小显示框
	 */
	private LocusPassWordView.onCheckListener lpwvOnCheckListener = new LocusPassWordView.onCheckListener() {
	 ...
	 */
	private LocusPassWordView.OnCompleteListener lpwvOnCompleteListener = new LocusPassWordView.OnCompleteListener() {
