...
public class CspXmlYfx014 {
	...
	private String WLS_LOAN_ACCT;// 贷款账号

	public CspXmlYfx014(String wLS_CUST_ID, String wLS_LOAN_ACCT) {
		super();
		WLS_CUST_ID = wLS_CUST_ID;
		WLS_LOAN_ACCT = wLS_LOAN_ACCT;
	}
	...
	public String getCspXml() {
		...
		try {
			...
			serializer.startTag(null, "WLS_LOAN_ACCT");
			serializer.text(WLS_LOAN_ACCT);
			serializer.endTag(null, "WLS_LOAN_ACCT");
