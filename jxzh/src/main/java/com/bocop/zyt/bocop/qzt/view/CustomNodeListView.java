package com.bocop.zyt.bocop.qzt.view;
...
public class CustomNodeListView extends LinearLayout {
	...
	public CustomNodeListView(Context context, AttributeSet attrs, int defStyle) {
		...
		LayoutInflater.from(context).inflate(
				R.layout.qzt_custom_node_listview_item, this);
	...
	public void setAdapter(BaseAdapter adapter) {
		...
		this.nodeRadiusDistances = ((QztProgressAdapter) adapter).getNodeRadiusDistances();
