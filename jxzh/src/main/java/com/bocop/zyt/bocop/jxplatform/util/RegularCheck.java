...
public class RegularCheck {
    ...
    /*
	    ...
	    电信：133、153、180、177、189、（1349卫通）
	    总结起来就是第一位必定为1，第二位必定为3或5或7或8，其他位置的可以为0-9
    */
        //String num = "[1][0-9]\\d{9}";//"[1]"代表第1位为数字1，"[3578]"代表第二位可以为3、5、7、8中的一个，"\\d{9}"代表后面是可以是0～9的数字，有9位。
        String num = "[1]\\d{10}";//前段只判断以1开头的11位号码即为手机号码。
...
//      String strPattern = "^[a-zA-Z][\\w\\.-]*[a-zA-Z0-9]@[a-zA-Z0-9][\\w\\.-]*[a-zA-Z0-9]\\.[a-zA-Z][a-zA-Z\\.]*[a-zA-Z]$";
    ...
    public static boolean isIp(String strIp) {
        String strPattern = "((25[0-5]|2[0-4]\\d|((1\\d{2})|([1-9]?\\d)))\\.){3}(25[0-5]|2[0-4]\\d|((1\\d{2})|([1-9]?\\d)))";
        Pattern p = Pattern.compile(strPattern);
