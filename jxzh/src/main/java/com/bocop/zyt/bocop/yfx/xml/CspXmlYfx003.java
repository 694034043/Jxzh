package com.bocop.zyt.bocop.yfx.xml;
...
public class CspXmlYfx003 {
	...
	private String WLS_CUST_NAME;
	private String WLS_SEX;
	private String WLS_ID_CARD;
	private String WLS_PHONE;
	private String WLS_CITY_NAME;
	private String WLS_COMPANY_NAME;
	private String WLS_COMPANY_PHONE;

	public CspXmlYfx003(String userId, String custName, String wLS_SEX,String idCard, String phone, String wLS_CITY_NAME,
			String companyName,String wLS_COMPANY_PHONE) {
		WLS_USER_ID = userId;
		WLS_CUST_NAME = custName;
		WLS_SEX = wLS_SEX;
		WLS_ID_CARD = idCard;
		WLS_PHONE = phone;
		WLS_CITY_NAME = wLS_CITY_NAME;
		WLS_COMPANY_NAME = companyName;
		WLS_COMPANY_PHONE = wLS_COMPANY_PHONE;
	}
	...
	public String getCspXml() {
		...
		try {
			...
			serializer.startTag(null, "WLS_CUST_NAME");
			serializer.text(WLS_CUST_NAME);
			serializer.endTag(null, "WLS_CUST_NAME");
			
			serializer.startTag(null, "WLS_SEX");
			serializer.text(WLS_SEX);
			serializer.endTag(null, "WLS_SEX");
			...
			serializer.startTag(null, "WLS_CITY_NAME");
			serializer.text(WLS_CITY_NAME);
			serializer.endTag(null, "WLS_CITY_NAME");

			serializer.startTag(null, "WLS_COMPANY_NAME");
			serializer.text(WLS_COMPANY_NAME);
			serializer.endTag(null, "WLS_COMPANY_NAME");
			
			serializer.startTag(null, "WLS_COMPANY_PHONE");
			serializer.text(WLS_COMPANY_PHONE);
			serializer.endTag(null, "WLS_COMPANY_PHONE");
