...
public class ArcProgress extends View {
	...
	protected void initByAttributes(TypedArray attributes) {
		...
		suffixTextSize = attributes
				.getDimension(R.styleable.ArcProgress_arc_suffix_text_size, default_suffix_text_size);
		...
		bottomTextSize = attributes
				.getDimension(R.styleable.ArcProgress_arc_bottom_text_size, default_bottom_text_size);
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		rectF.set(strokeWidth / 2f, strokeWidth / 2f, width - strokeWidth / 2f, MeasureSpec.getSize(heightMeasureSpec)
				- strokeWidth / 2f);
	...
	protected void onDraw(Canvas canvas) {
		...
		float finishedSweepAngle = Float.parseFloat(progress + "") / getMax() * arcAngle;
		...
		String text = format.format(getProgress());
