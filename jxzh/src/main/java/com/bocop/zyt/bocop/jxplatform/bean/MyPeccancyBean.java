...
/** 
 * @author luoyang  
 * @version 创建时间：2015-6-30 下午3:22:16 
 * 类说明 
 */

public class MyPeccancyBean {

	private String idCard; 			//身份证
	private String userId;			//开放平台用户ID
	
	private String peccancyNum;		//处罚单编号
	private String bornTime;		//处罚决定书生成时间
