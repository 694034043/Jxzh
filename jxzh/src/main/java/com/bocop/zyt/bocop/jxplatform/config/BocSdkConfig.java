package com.bocop.zyt.bocop.jxplatform.config;
...
public class BocSdkConfig {
	...
	//public static String CONSUMER_SECRET = "0a47f37943dee85aa42f5d665706e9b00ba536cf2820c70c4f";// 测试环境
	...
	//public static String CONSUMER_SECRET = "06b60a2b92995afd6937412443c3f1d49cccf1682ad9f9a40d";// 测试环境
...
//	 public static String CONSUMER_SECRET = "269f8e525d1d2fc9a002e68c667c4200b5176a2d47518faffe";//生产环境
	...
	public static String CONSUMER_PAY_URL = "https://api.boc.dcorepay.com";//支付环境
	// **************************************************************************************************************

	public static String ALIPAY_URL = CONSUMER_PAY_URL+"/alipay";
...
//	public static String HTTP_URL = "http://22.188.12.105/wap";// 测试环境
	...
	// 便民缴费URL
//	public static String bmjfurl = "http://219.141.191.126:80/conPayH5/?channel=jxzyh";// 测试环境
	public static String bmjfurl =
			"http://219.141.191.126:80/conPayH5/?channel=jxeht";//生产环境
	...
	// CONSUMER_PORT
	// + "/bocop/mcis";
	//public final static String LOGIN_MCISCSP = CONSUMER_URL + ":" + CONSUMER_PORT + "/mciscsp";
	public final static String LOGIN_MCISCSP = CONSUMER_URL  + "/mciscsp";
//	public final static String LOGIN_MCISCSP = "http://59.63.161.77:8082/TestWeb/csptest.do";
...
//	public static String qztUrl = "http://22.220.75.101:8080";
	...
	//订单详情
	public static String qztOrderDetailUrl = qztUrl + "/qzt/selector.do?method=orderInfo";
	//签证进度
	...
	//	public static String postForLog = qztUrl + "/qzt/selector.do?method=logininfo";
	...
	//public final static String YFX_DRAWING_CONFIRM = "http://123.124.191.179/wlsasr/loan.do";// 工薪贷测试环境
	public final static String YFX_DRAWING_CONFIRM = "http://123.124.191.179/wlsasr2/loan2.do";// 工薪贷测试环境
//	public final static String YFX_DRAWING_CONFIRM = "http://22.220.75.75:8080/asr/loan2.do";// 工薪贷测试环境
...
//	public static final String CFT = "http://123.124.191.179/cft/index.html";
	...
	//汇兑通
	public static final String HUIDUITONG = "https://openapi.boc.cn/af/newMobileHtml/index.html#/app/main?channel=android&header=0&order=2&chnway=386";
	//优品通
	public static final String YPT = "https://jf365.boc.cn/BOCCMALL_M/index.do";
	//理财通
	public static final String LCT = "https:/openapi.boc.cn/ezdb/mobileHtml/html/userCenter/index.html?channel=android&source=000001";
	...
	public static final String fpsc = "http://lbq.jxpost.com/wechat/api/appLoadIndex?code=yihutongAPP";
...
//	public static final String WEIHUI = "http://22.220.13.64:8080/wxyx/wx/page/forword/jingxuan.ht?authToken=26fa5fbda9cd476d899432dad4c5a982&authApp=yht&userId=";
	public static final String WEIHUI = "http://jxboc.uni-infinity.com/wxyx/wx/page/forword/jingxuan.ht?authToken=26fa5fbda9cd476d899432dad4c5a982&authApp=yht&userId=";
...
//	http://123.124.191.179/cyh/car_search.html
	...
	public static final String LLYHURL = "http://123.124.191.179/fenghang-web/common/loginNew.do";
	//yuxinhan4-5
	public static String infomalLogin = qztUrl + "/yhtlog/selector.do?method=informallogin";
	//签证通酒店预订
	public static String qztJiudianUrl = qztUrl + "/file/images/qzt/visa_jdyd.png";
	//签证通全球WIFI
	public static String qztWifiUrl = qztUrl + "/file/images/qzt/visa_qqwifi.png";
}
