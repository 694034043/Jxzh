...
import com.bocop.zyt.bocop.yfx.activity.loanprodetail.PersonalInfoActivity;
import com.bocop.zyt.bocop.yfx.activity.loanprodetail.PreviewAuthentInfoActivity;
import com.bocop.zyt.bocop.yfx.activity.loanprodetail.RealNameAuthentActivity;
import com.bocop.zyt.bocop.yfx.bean.InfoStatusResponse;
import com.bocop.zyt.bocop.yfx.view.JustifyTextView;
import com.bocop.zyt.bocop.yfx.xml.CspXmlYfx001;
...
//			llFNT.setVisibility(View.GONE);
		...
		case 9:// 公积贷
			...
			break;
		case HomeFragmentHelper.TAG_XIAO_FEI_DAI:// 公积贷
			setAdHeight(HomeFragmentHelper.TAG_XIAO_FEI_DAI);
			initAdList(HomeFragmentHelper.TAG_XIAO_FEI_DAI);
			notifyForAdPic();
			rlBG.setBackgroundResource(R.drawable.yfx_bg_fpt);
			tvFptText.setVisibility(View.GONE);
			tvFptSubText.setVisibility(View.GONE);
	...
	private void initAdList(int flag) {
		...
		case HomeFragmentHelper.TAG_XIAO_FEI_DAI:
			Advertisement xfed1 = new Advertisement();
			xfed1.setImageRes(R.drawable.pic_gong_top_banner_01);
			mAdvList.add(xfed1);
			ivSteps.setImageResource(R.drawable.yfx_trains_steps);
			break;
		}
