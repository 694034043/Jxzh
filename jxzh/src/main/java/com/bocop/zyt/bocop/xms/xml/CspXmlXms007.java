package com.bocop.zyt.bocop.xms.xml;
 ...
 *
 */
public class CspXmlXms007 {
	
	public CspXmlXms007(String strUserId, String page){
		USER_ID = strUserId;
		PAGE = page;
	}
