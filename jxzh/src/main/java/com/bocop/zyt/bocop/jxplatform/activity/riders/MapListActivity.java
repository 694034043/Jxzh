...
import com.bocop.zyt.bocop.jxplatform.bean.etc.ETCMapBean;
import com.bocop.zyt.bocop.jxplatform.http.RestTemplate;
import com.bocop.zyt.jx.ab.common.pullview.AbPullToRefreshView;
import com.bocop.zyt.jx.baseUtil.asynchttpclient.JsonHttpResponseHandler;
 ...
 * 
 */
public class MapListActivity extends FragmentActivity implements
...
//			test();
	...
	private void getCurrentPoint(LocationData locData) {
	...
	private void test() {
		...
		try {
			tempList = JSON.parseArray(
					new JSONObject(tempJsonData).getString("rows"),
					ETCMapBean.class);
