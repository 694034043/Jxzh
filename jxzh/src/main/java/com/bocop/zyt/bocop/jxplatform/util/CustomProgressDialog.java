...
import com.bocop.zyt.bocop.jxplatform.activity.HTZQActivity;
import com.bocop.zyt.bocop.jxplatform.activity.WebTitleActivity;
import com.bocop.zyt.bocop.jxplatform.activity.WebViewCommActivity;
import com.bocop.zyt.bocop.jxplatform.activity.WebViewGetTitleActivity;
...
//						HTZQActivity.class);
				...
				try {
					if(className.contains("HTZQActivity")){
						...
						intent.putExtras(bundle);
						context.startActivity(intent);
					}else if(className.contains("qztjiudian")){
						...
						Intent intentExchange = new Intent(context, WebViewCommActivity.class);
						intentExchange.putExtras(bundleExchange);
						context.startActivity(intentExchange);
					}else if(className.contains("qztwifi")){
						Bundle bundleExchange = new Bundle();
						bundleExchange.putString("url", Constants.qztUrlForWifi);
						bundleExchange.putString("name", "全球Wifi");
//						Intent intentExchange = new Intent(context, WebViewCommActivity.class);
						Intent intentExchange = new Intent(context, WebTitleActivity.class);
						intentExchange.putExtras(bundleExchange);
						context.startActivity(intentExchange);
					}
//					context.startActivity(intent);
	 ...
	 *            上下文对象
	 */
	public static void showBocFengxianDialog(final Context context,String strTitle,String strAdvise) {
		Activity activity = null;
		BocopDialog dialog = null;
		dialog = new BocopDialog(context, strTitle,strAdvise);
	 ...
	 *            上下文对象
	 */
	public static void showBocFengxianDialog(final Context context,String strTitle,String strAdvise,final String className,final String title,final boolean isShowParamsTitle) {
		Activity activity = null;
		BocopDialog dialog = null;
		dialog = new BocopDialog(context, strTitle,strAdvise);
