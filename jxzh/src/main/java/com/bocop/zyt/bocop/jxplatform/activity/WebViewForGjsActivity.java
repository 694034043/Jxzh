...
public class WebViewForGjsActivity extends BaseActivity {
...
//		webView.addJavascriptInterface(this, "nativeApp");
		...
		webView.setWebViewClient(new WebViewClient() {
			...
			public void onPageStarted(WebView view, String url, Bitmap favicon) {
				...
				if (NetworkUtils.isNetworkConnected(WebViewForGjsActivity.this)) {
					llNetworkLoad.setVisibility(View.INVISIBLE);
					webView.setVisibility(View.VISIBLE);
					llNetworkClosed.setVisibility(View.INVISIBLE);
				} else {
					view.stopLoading();
					CustomProgressDialog.showBocNetworkSetDialog(WebViewForGjsActivity.this);
					if(webView.canGoBack()){
						webView.goBack();
					}
				}
