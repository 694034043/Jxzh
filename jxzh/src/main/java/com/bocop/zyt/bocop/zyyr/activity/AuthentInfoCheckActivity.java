...
import com.bocop.zyt.bocop.zyyr.bean.AuthenInfo;
import com.bocop.zyt.bocop.zyyr.bean.KeyAndValue;
import com.bocop.zyt.bocop.zyyr.bean.ListParaResponse;
...
public class AuthentInfoCheckActivity extends BaseActivity {
	...
	private void requestAuthenInfoSubmit() {
		...
		cspUtil.postCspNoLogin(BocSdkConfig.ZYYR_MODIFY_USERINFO, formBody, true, new CspUtil.CallBack() {
			@Override
	...
	private void requestData() {
		...
		CspUtil cspUtil = new CspUtil(this);
		cspUtil.postCspNoLogin(BocSdkConfig.ZYYR_LIST_PARA, formBody, true, new CspUtil.CallBack() {
			@Override
			public void onSuccess(String responStr) {
