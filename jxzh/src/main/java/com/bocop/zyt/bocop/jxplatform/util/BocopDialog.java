...
public class BocopDialog extends Dialog {
	 ...
	 * 设置取消按钮的监听与文字
	 */
	public void setNegativeButton(OnClickListener onNegativeListener,String text) {
	 ...
	 * 设置取消按钮的监听与文字的资源id
	 */
	public void setNegativeButton(OnClickListener onNegativeListener,int textId) {
		setNegativeButton(onNegativeListener,mContext.getString(textId));
	}
	/**
	 * 设置取消监听
	 */
	public void setNegativeListener(OnClickListener onNegativeListener) {
		setNegativeButton(onNegativeListener, "取消");		
	}
	/**
	 * 设置确定监听与文字
	 */
	public void setPositiveButton(OnClickListener onPositiveListener,String text) {
	 ...
	 * 设置确定监听与文字的资源id
	 */
	public void setPositiveButton(OnClickListener onPositiveListener,int textId) {
		setPositiveButton(onPositiveListener, mContext.getString(textId));
	}
	/**  
	 * 设置确定监听
	 */
	public void setPositiveListener(OnClickListener onPositiveListener) {
