...
import com.bocop.zyt.bocop.jxplatform.adapter.QztOrderAdapter;
import com.bocop.zyt.bocop.jxplatform.bean.QztOrderBean;
import com.bocop.zyt.bocop.jxplatform.bean.QztOrderListBean;
...
public class QztOrderActivity extends BaseActivity {
	...
	public void requestBocopForQztOrder(){
		...
		qztRequestWithJsonAndBody.postOpboc(strGson, BocSdkConfig.qztOrderUrl, new QztRequestWithJsonAndBody.CallBackBoc(){
			@Override
